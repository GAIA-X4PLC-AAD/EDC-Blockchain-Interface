...
class Contract(sp.Contract):
    def __init__(self):
        ...
        self.init(administrator = sp.address('tz1Na21NimuuPXcQdHUk2en2XWYe9McyDDgZ'),
                  ...
                  operators = sp.set([sp.address('tz1Na21NimuuPXcQdHUk2en2XWYe9McyDDgZ')]))
...
def test():
    ...
    ).run(sender=sp.address("tz1Na21NimuuPXcQdHUk2en2XWYe9McyDDgZ")) #Should pass
    #    sp.address("tz1W6FF4j95sA7JBgV35Q2n7mDFkXYwmCUVL")
    #).run(sender=sp.address("tz1W6FF4j95sA7JBgV35Q2n7mDFkXYwmCUVL")) #Should fail
