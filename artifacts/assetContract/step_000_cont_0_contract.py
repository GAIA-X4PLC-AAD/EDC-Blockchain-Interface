...
class Contract(sp.Contract):
  def __init__(self):
    ...
    self.init(administrator = sp.address('tz1Na21NimuuPXcQdHUk2en2XWYe9McyDDgZ'),
              ...
              last_token_id = 0,
              ledger = {},
              metadata = {'' : sp.bytes('0x68747470733a2f2f697066732e696f2f697066732f516d556d55714643526a6354416b506753667375556d64735750524e444a6d454332737762465842363233723678')},
              token_metadata = {})
