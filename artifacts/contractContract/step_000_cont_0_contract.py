...
class Contract(sp.Contract):
  def __init__(self):
    ...
    self.init(administrator = sp.address('tz1Na21NimuuPXcQdHUk2en2XWYe9McyDDgZ'),
              ...
              last_token_id = 0,
              ledger = {},
              metadata = {'' : sp.bytes('0x68747470733a2f2f697066732e696f2f697066732f516d5476514135554d584b366243596a5438555541704a754d4b424a67796e525a35373435415165774e6b766343')},
              token_metadata = {})
  ...
  def mint(self, params):
    ...
    sp.for action in params:
      compute_contract_contract_35 = sp.local("compute_contract_contract_35", self.data.last_token_id)
      self.data.token_metadata[compute_contract_contract_35.value] = sp.record(token_id = compute_contract_contract_35.value, token_info = action.metadata)
      self.data.ledger[compute_contract_contract_35.value] = action.to_
